...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory("navs"), "maps", "map.yaml"
        ),
    )
    ...
    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join(
            get_package_share_directory("navs"), "config", "nav2_params_amcl.yaml"
        ),
    )
    ...
    rviz_config_dir = os.path.join(get_package_share_directory("navs"), "rviz2", "rviz.rviz")
