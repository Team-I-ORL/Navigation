...
# A template launch for muxing the teleop and the navigation stack
...
def generate_launch_description():
   ...
   twist_mux_node = Node(
      ...
      remappings=[('/cmd_vel_out','diff_cont/cmd_vel_unstamped')] # remaps twist mux output to the diff controller
   )
